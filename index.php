...
<div class="banner">
	<div class="container">
		<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Minakit Packages</h1>
	</div>
	</div>
</div>
...
<div><a href="package-list.php" class="view">More Minakit Packages</a></div>
</div>
			<div class="clearfix"></div>
	</div>
